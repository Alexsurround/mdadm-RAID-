...
Сборник команд и сценариев для диагностики, восстановления и предотвращения проблем с программным RAID (mdadm) в Debian/Ubuntu. Основано на реальном кейсе восстановления RAID5 (`md54`), ушедшего в `inactive`.
